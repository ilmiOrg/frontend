...
const ConnectFriendsPage = () => {
  return (
    <PageTemplate
      ...
      description="Build your network with fellow applicants"
      actions={
    ...
    >
      <div className={styles.contentContainer}>
        <div className={styles.infoSection}>
          <h2 className={styles.sectionTitle}>Welcome to Connect Friends!</h2>
          <p className={styles.sectionText}>
            Build your network with fellow applicants. This powerful feature will help you achieve your university goals faster and more efficiently.
          </p>
        ...
        <div className={styles.actionSection}>
          <div className={styles.actionCard}>
            ...
            <p className={styles.actionText}>
              Begin your journey with Connect Friends and unlock your full potential.
            </p>
