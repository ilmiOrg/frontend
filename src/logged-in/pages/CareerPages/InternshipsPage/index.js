    ...
    >
      <div className={styles.contentContainer}>
        <div className={styles.infoSection}>
          <h2 className={styles.sectionTitle}>Welcome to Internships Matching!</h2>
          <p className={styles.sectionText}>
            Find internship opportunities that match your goals. This powerful feature will help you achieve your university goals faster and more efficiently.
          </p>
        ...
        <div className={styles.actionSection}>
          <div className={styles.actionCard}>
            ...
            <p className={styles.actionText}>
              Begin your journey with Internships Matching and unlock your full potential.
            </p>
