    ...
    >
      ...
      <aside
        className={`${styles.leftSidebar} ${
          leftSidebarCollapsed ? styles.sidebarCollapsed : ""
        }`}
      >
        ...
        >
          ...
          <div className={styles.navSection}>
            ...
            {expandedSections.main && (
              <>
                ...
                <button
                  onClick={() => handleNavClick("/dashboard/dream-university")}
                ...
                <button
                  onClick={() =>
                    handleNavClick("/dashboard/search/universities")
                  }
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>🔍</span>
                ...
                <button
                  onClick={() => handleNavClick("/dashboard/study-together")}
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>📚</span>
                ...
                <button
                  onClick={() => handleNavClick("/dashboard/university-reels")}
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>🎬</span>
          ...
          <div className={styles.navSection}>
            <div
              className={styles.navSectionTitle}
              onClick={() => toggleSection("applicationManagement")}
            >
              Application Management{" "}
            ...
            {expandedSections.applicationManagement && (
              <>
                <button
                  onClick={() =>
                    handleNavClick("/dashboard/applications/timeline")
                  }
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>📅</span>
                ...
                <button
                  onClick={() =>
                    handleNavClick("/dashboard/applications/documents")
                  }
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>📄</span>
          ...
          <div className={styles.navSection}>
            <div
              className={styles.navSectionTitle}
              onClick={() => toggleSection("aiMatching")}
            >
            ...
            {expandedSections.aiMatching && (
              <>
                <button
                  onClick={() =>
                    handleNavClick("/dashboard/ai/match-universities")
                  }
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>🎯</span>
                ...
                <button
                  onClick={() =>
                    handleNavClick("/dashboard/ai/match-scholarships")
                  }
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>🎯</span>
                ...
                <button
                  onClick={() =>
                    handleNavClick("/dashboard/ai/similar-students")
                  }
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>👥</span>
          ...
          <div className={styles.navSection}>
            ...
            {expandedSections.community && (
              <>
                <button
                  onClick={() => handleNavClick("/dashboard/community/friends")}
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>👫</span>
                ...
                <button
                  onClick={() => handleNavClick("/dashboard/community/mentors")}
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>🎓</span>
          ...
          <div className={styles.navSection}>
            ...
            {expandedSections.career && (
              <>
                <button
                  onClick={() =>
                    handleNavClick("/dashboard/career/internships")
                  }
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>💼</span>
                ...
                <button
                  onClick={() => handleNavClick("/dashboard/career/masters")}
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>💼</span>
                ...
                <button
                  onClick={() => handleNavClick("/dashboard/career/analysis")}
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>📊</span>
          ...
          <div className={styles.navSection}>
            ...
            {expandedSections.premium && (
              <>
                <button
                  onClick={() =>
                    handleNavClick("/dashboard/premium/essay-reviews")
                  }
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>📝</span>
                ...
                <button
                  onClick={() =>
                    handleNavClick("/dashboard/premium/mock-interviews")
                  }
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>🎤</span>
                ...
                <button
                  onClick={() => handleNavClick("/dashboard/premium/concierge")}
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>🎩</span>
          ...
          <div className={styles.navSection}>
            ...
            {expandedSections.learning && (
              <>
                <button
                  onClick={() => handleNavClick("/dashboard/courses")}
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>📝</span>
                ...
                <button
                  onClick={() => handleNavClick("/dashboard/courses/math")}
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>🔢</span>
                ...
                <button
                  onClick={() => handleNavClick("/dashboard/courses/english")}
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>📚</span>
                ...
                <button
                  onClick={() =>
                    handleNavClick("/dashboard/courses/essay-writing")
                  }
                  className={styles.navItem}
                >
                ...
                <button
                  onClick={() =>
                    handleNavClick("/dashboard/courses/ai-literacy")
                  }
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>🤖</span>
          ...
          <div className={styles.navSection}>
            ...
            {expandedSections.privacy && (
              <>
                <button
                  onClick={() => handleNavClick("/dashboard/privacy")}
                  className={styles.navItem}
                >
                  <span className={styles.navIcon}>🔒</span>
      ...
      <main className={styles.mainContent}>
        ...
        <div className={styles.mainContentInner}>
          ...
          <div className={styles.topNavbar}>
              ...
              <div className={styles.profileSectionCompact}>
                <div className={styles.profileMain}>
                  ...
                  <div className={styles.profileInfoVertical}>
                    ...
                    <span className={styles.profileBadge}>{userEmail}</span>
                  </div>
                  <div className={styles.profileTimezoneInfo}>
                    <span className={styles.timezoneText}>
                      Times are converted to Bishkek time (GMT+6)
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className={styles.navbarRight}>
              <div className={styles.quickActions}>
                ...
                <LanguageSwitcher className={styles.dashboardLang} />
          ...
          <div className={styles.dashboardGridExtended}>
            ...
            <div
              className={`${styles.dashboardCard} ${styles.dreamUniversityCard}`}
            >
                ...
                <div className={styles.dreamProgress}>
                  <div className={styles.progressRing}>
                    ...
                    >
                      ...
                      ></circle>
                      <circle
                        className={`${styles.progressRingCircle} ${styles.dreamRing}`}
                        cx="25"
                        cy="25"
                        r="20"
                      ></circle>
              ...
              <div className={styles.dreamUniversityContent}>
                <div className={styles.dreamUniversityVisual}>
                  ...
                  <div className={styles.universityNameLarge}>
                    University of Central Asia
                  </div>
                  <div className={styles.universityLocationLarge}>
                    Naryn, Kyrgyzstan
                  </div>
                </div>
                <div className={styles.dreamActions}>
                  <button
                    className={`${styles.dreamBtn} ${styles.dreamBtnPrimary}`}
                  >
                    <span className={styles.btnIcon}>🏔️</span>
                    Start Climb
                  </button>
                  <button
                    className={`${styles.dreamBtn} ${styles.dreamBtnSecondary}`}
                  >
                ...
                <div className={`${styles.deadlineItem} ${styles.urgent}`}>
                  ...
                  <div className={styles.deadlineBar}>
                    <div
                      ...
                      style={{ width: "90%", backgroundColor: "#EF4444" }}
                    ></div>
                  </div>
            ...
            <div
              className={`${styles.dashboardCard} ${styles.universityViewsCard}`}
            >
              <div className={styles.cardHeader}>
              ...
              <div className={styles.universityViewsDescription}>
                <p>
                  Track how many universities and scholarships you've viewed
                </p>
              </div>
          ...
          <section className={styles.smartMatchingWrapper}>
            <div className={styles.smartMatchingSection}>
              ...
              <div className={styles.smartMatchingContent}>
                <p>
                  Our AI-powered algorithm matches you with universities that
                ...
                <div className={styles.matchingFeatures}>
                  <div className={styles.featureCard}>
                    ...
                    <div className={styles.featureContent}>
                      ...
                      <p>
                        Discover thousands of scholarship opportunities tailored
                        to your profile and academic achievements.
                      </p>
                    </div>
                  </div>
                  <div className={styles.featureCard}>
                    ...
                    <div className={styles.featureContent}>
                      ...
                      <p>
                        Compare universities side by side with detailed
                        statistics, rankings, and student reviews.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className={styles.searchScholarshipsSection}>
              ...
              <div className={styles.scholarshipResults}>
                <div className={styles.scholarshipCard}>
                  ...
                  <p>
                    Full scholarship for outstanding minority students pursuing
                    undergraduate degrees.
                  </p>
                  <div className={styles.scholarshipFooter}>
                    <span className={styles.scholarshipDeadline}>
                      Deadline: March 15
                    </span>
              ...
              <div className={styles.reelsContainer}>
                <div className={styles.reelCard}>
                  ...
                  <div className={styles.reelInfo}>
                    ...
                    <p>
                      Explore the iconic MIT campus and discover what makes it
                ...
                <div className={styles.reelCard}>
                  ...
                  <div className={styles.reelInfo}>
                    ...
                    <p>
                      A day in the life of a Stanford student - from morning
                      classes to late-night study sessions! 📚
                    </p>
                    <div className={styles.reelStats}>
                      <span>👁️ 1.8k</span>
                      <span>❤️ 98</span>
                ...
                <div className={styles.mentorCard}>
                  ...
                  <div className={styles.mentorInfo}>
                    ...
                    <div className={styles.mentorDetails}>
                      <span className={styles.mentorField}>
                        Computer Science
                      </span>
                      <span className={styles.mentorSpecialty}>
                        Career Guidance
                      </span>
                    </div>
              ...
              <div className={styles.internshipResults}>
                <div className={styles.internshipCard}>
                  <div className={styles.internshipHeader}>
                    ...
                    <span className={styles.internshipLocation}>
                      Mountain View, CA
                    </span>
                  </div>
            ...
            <div className={styles.conciergeSection}>
              ...
              <div className={styles.liveSupport}>
                ...
                <div className={styles.supportMessage}>
                  <p>
                    <strong>I need help with my MIT application</strong>
                  </p>
