      ...
      <div className={styles.header}>
        <div className={styles.headerContent}>
          ...
          <div>
            ...
            <p className={styles.description}>Connect with peers and study groups</p>
          </div>
        </div>
      ...
      <div className={styles.contentContainer}>
        <div className={styles.infoSection}>
          ...
          <p className={styles.sectionText}>
            Connect with peers and study groups. This powerful feature will help you achieve your university goals faster and more efficiently.
          </p>
        ...
        <div className={styles.actionSection}>
          <div className={styles.actionCard}>
            ...
            <p className={styles.actionText}>
              Begin your journey with Study Together and unlock your full potential.
            </p>
