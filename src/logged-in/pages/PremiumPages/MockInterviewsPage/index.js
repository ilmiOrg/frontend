      ...
      <div className={styles.contentContainer}>
        <div className={styles.infoSection}>
          ...
          <p className={styles.sectionText}>
            Practice with real admission officers. This powerful feature will help you achieve your university goals faster and more efficiently.
          </p>
        ...
        <div className={styles.actionSection}>
          <div className={styles.actionCard}>
            ...
            <p className={styles.actionText}>
              Begin your journey with Mock Interviews and unlock your full potential.
            </p>
